...
final class MessageFormatterTest extends TestCase
{
	...
	public function provideNumber(): Generator
	{
		...
		yield ['en_US', 'I have {number_apples, number, integer} apples.', ['number_apples' => 3], 'I have 3 apples.'];

		// TODO - another languages
		//yield ['ar', 'I have {number_apples, number, integer} apples.', ['number_apples' => 3], 'I have ٣ apples.'];
		//yield ['br', 'I have {number_apples, number, integer} apples.', ['number_apples' => 3], 'I have ৩ apples.'];
	}
	...
	{
		yield ['en-US', 'I have {number_apples, plural, =0{no apples} =1{one apple} other{# apples}}', ['number_apples' => 0], 'I have no apples'];
		yield ['en-US', 'I have {number_apples, plural, =0{no apples} =1{one apple} other{# apples}}', ['number_apples' => 1], 'I have one apple'];
		yield ['en-US', 'I have {number_apples, plural, =0{no apples} =1{one apple} other{# apples}}', ['number_apples' => 10], 'I have 10 apples'];
	}
